<?php
// with static methods we  can't use $this!
class Student {
...
// static variables are shared throughout the inheritance tree.
  ...
  Two::$foo = 2;
  Three::$foo = 3;
  echo One::$foo;   // 3; this is because when we change static variable in any class it references the same variable and changes them.
  echo Two::$foo;   // 3
  echo Three::$foo; // 3
?>
